...
## Subject
A hub website for **JustAdev742** (GitHub handle) that links the owner's Cards Against The Humanity site and shows their ARC-AGI-3 work on Kaggle. The brief asks for the site to "link exactly joviangame.me" and to be "the best you can".
...
- **Jovian Engine — left out.** The owner asked twice: "please don't do the Jovian engine website". The engine, its name and its website are excluded from the site entirely. (Its page text was read once for facts before that instruction; nothing from it is used, and the local copies of its repositories were deleted.)
...
- **Last push dates (GitHub, UTC)** — cards-against-the-humanity 2026-09-20; Arc-Agi-3-Kaggle-comp 2026-09-24 00:04; Websites 2026-09-24 07:02.
...
6. ARC-AGI-3
7. Developing AI stuff on Kaggle.
8. ARC Prize 2026

Lines 4 and 5 are the owner's own copy and URL. Line 7 paraphrases the brief ("developing ai stuff in kaggle arc-agi-3"). Line 8 is the competition's name. The Jovian Engine lines were removed from all ten directions at the owner's request. Nothing else is invented; no real name is used.

## Tensions worth keeping
- "Just a dev" versus an AGI benchmark.
...
- **Prohibited:** other designers, galleries, portfolio sites, templates, UI kits, design tokens, icon libraries, Google Fonts or other platform house styles as input, the Jovian Engine and its website, the official Cards Against Humanity visual identity, AI-generated imagery.
